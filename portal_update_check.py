...
Тихую автоустановку не делаем (подпись SmartScreen/notarize/права);
показываем диалог и открываем прямую ссылку на ассет (Windows: PortalSetup.exe, иначе ZIP).
"""
