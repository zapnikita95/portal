...
В главном окне задай **одинаковый пароль на всех своих ПК** (кнопки «Сгенерировать» / «Сохранить»). В первом JSON каждого запроса уходит поле `secret`; приёмник сравнивает его с сохранённым значением (**без новых зависимостей**, `hmac.compare_digest`).
