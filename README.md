...
- 📁 **Куда сохранять входящие файлы** — в главном окне поле «Куда сохранять входящие файлы» + «Сохранить папку» (по умолчанию **Рабочий стол**, с учётом OneDrive на Windows)
