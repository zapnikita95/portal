...
STRINGS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "settings.mdns_note": "Видно другим в «Найти локально» рядом с IP. Пустое поле — как имя хоста Windows/macOS. Нужен пакет: pip install zeroconf.",
    ...
    "en": {
        ...
        "settings.mdns_note": "Others see it in “Find on LAN” next to the IP. Empty = OS hostname. Requires: pip install zeroconf.",
