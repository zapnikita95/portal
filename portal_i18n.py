...
STRINGS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "lan.none": "На порту Portal в выбранных подсетях никого не видно. Проверь: на другом устройстве Портал запущен, тот же Wi‑Fi (или Tailscale), файрвол не режет порт.",
    ...
    "en": {
        ...
        "lan.none": "No Portal peers on these subnets. Check: Portal is running on the other device, same Wi‑Fi (or Tailscale), firewall allows the port.",
