...
STRINGS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "recv.mode_title": "Режим входящих файлов (не из «буферного» push с другого устройства):",
        ...
        "peers.groups_hint": "В группу впиши IP через запятую. На главной отметь группу галочкой — буфер и файлы уйдут на все её IP (вместе с отмеченными пирами).",
        "peers.add_group_row": "➕ Группа",
    ...
    "en": {
        ...
        "peers.groups_hint": "Enter IPs separated by commas. On the main screen, tick a group to send clipboard/files to all its IPs (plus ticked peers).",
        "peers.add_group_row": "➕ Group",
